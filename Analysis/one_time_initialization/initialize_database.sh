...
mysql -u user -pa --database='bt2' --execute="CREATE TABLE GATT_characteristic_descriptor_values (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, bdaddr_random BOOLEAN NOT NULL, UUID CHAR(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, descriptor_handle SMALLINT UNSIGNED NOT NULL, operation TINYINT UNSIGNED NOT NULL, byte_values BLOB NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, bdaddr_random, UUID, descriptor_handle, operation, byte_values(1024))) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

echo "Creating L2CAP tables"
mysql -u user -pa --database='bt2' --execute="CREATE TABLE L2CAP_CONNECTION_PARAMETER_UPDATE_REQ (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, bdaddr_random BOOLEAN NOT NULL, direction TINYINT UNSIGNED NOT NULL, code TINYINT UNSIGNED NOT NULL, pkt_id TINYINT UNSIGNED NOT NULL, data_len SMALLINT UNSIGNED NOT NULL, interval_min SMALLINT UNSIGNED NOT NULL, interval_max SMALLINT UNSIGNED NOT NULL, latency SMALLINT UNSIGNED NOT NULL, timeout SMALLINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, bdaddr_random, direction, code, pkt_id, data_len, interval_min, interval_max, latency, timeout)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

mysql -u user -pa --database='bt2' --execute="CREATE TABLE L2CAP_CONNECTION_PARAMETER_UPDATE_RSP (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, bdaddr_random BOOLEAN NOT NULL, direction TINYINT UNSIGNED NOT NULL, code TINYINT UNSIGNED NOT NULL, pkt_id TINYINT UNSIGNED NOT NULL, data_len SMALLINT UNSIGNED NOT NULL, result SMALLINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, bdaddr_random, direction, code, pkt_id, data_len, result)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
...
mysql -u user -pa --database='bt2' --execute="CREATE TABLE SDP_ERROR_RSP (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, direction TINYINT UNSIGNED NOT NULL, l2cap_len SMALLINT UNSIGNED NOT NULL, l2cap_cid SMALLINT UNSIGNED NOT NULL, transaction_id SMALLINT UNSIGNED NOT NULL, param_len SMALLINT UNSIGNED NOT NULL, error_code SMALLINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, direction, l2cap_len, l2cap_cid, transaction_id, param_len, error_code)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

mysql -u user -pa --database='bt2' --execute="CREATE TABLE SDP_Common (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, direction TINYINT UNSIGNED NOT NULL, l2cap_len SMALLINT UNSIGNED NOT NULL, l2cap_cid SMALLINT UNSIGNED NOT NULL, pdu_id TINYINT UNSIGNED NOT NULL, transaction_id SMALLINT UNSIGNED NOT NULL, param_len SMALLINT UNSIGNED NOT NULL, byte_values VARBINARY(1024), hash CHAR(40) GENERATED ALWAYS AS (SHA1(byte_values)) STORED, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, direction, l2cap_len, l2cap_cid, pdu_id, transaction_id, param_len, hash));"
...
mysql -u user -pa --database='bt2' --execute="CREATE TABLE LMP_ACCEPTED (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, rcvd_opcode TINYINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, rcvd_opcode)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

mysql -u user -pa --database='bt2' --execute="CREATE TABLE LMP_NOT_ACCEPTED (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, rcvd_opcode TINYINT UNSIGNED NOT NULL, error_code TINYINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, rcvd_opcode, error_code)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

mysql -u user -pa --database='bt2' --execute="CREATE TABLE LMP_DETACH (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, error_code TINYINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, error_code)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

mysql -u user -pa --database='bt2' --execute="CREATE TABLE LMP_PREFERRED_RATE (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, data_rate TINYINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, data_rate)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
...
mysql -u user -pa --database='bt2' --execute="CREATE TABLE LMP_ACCEPTED_EXT (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, rcvd_escape_opcode TINYINT UNSIGNED NOT NULL, rcvd_extended_opcode TINYINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, rcvd_escape_opcode, rcvd_extended_opcode)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

mysql -u user -pa --database='bt2' --execute="CREATE TABLE LMP_NOT_ACCEPTED_EXT (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, rcvd_escape_opcode TINYINT UNSIGNED NOT NULL, rcvd_extended_opcode TINYINT UNSIGNED NOT NULL, error_code TINYINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, rcvd_escape_opcode, rcvd_extended_opcode, error_code)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

mysql -u user -pa --database='bt2' --execute="CREATE TABLE LMP_FEATURES_REQ_EXT (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, page TINYINT UNSIGNED NOT NULL, max_page TINYINT UNSIGNED NOT NULL, features BIGINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, page, max_page, features)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
...
mysql -u user -pa --database='bt2' --execute="CREATE TABLE LMP_CHANNEL_CLASSIFICATION (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, afh_channel_classification BLOB NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, afh_channel_classification(10))) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

mysql -u user -pa --database='bt2' --execute="CREATE TABLE LMP_POWER_CONTROL_REQ (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, power_adj_req TINYINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, power_adj_req)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

mysql -u user -pa --database='bt2' --execute="CREATE TABLE LMP_POWER_CONTROL_RES (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, power_adj_res TINYINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, power_adj_res)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
