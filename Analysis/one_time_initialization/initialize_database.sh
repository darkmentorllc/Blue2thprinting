...
mysql -u user -pa --database='bt' --execute="CREATE TABLE BLEScope_UUID128s (id INT NOT NULL AUTO_INCREMENT, android_pkg_name VARCHAR(100), uuid_type TINYINT NOT NULL, str_UUID128 VARCHAR(37), PRIMARY KEY (id), UNIQUE KEY uni_name (android_pkg_name, uuid_type, str_UUID128));"
