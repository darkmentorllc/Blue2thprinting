...
mysql -u user -pa --database='bttest' --execute="CREATE TABLE EIR_bdaddr_to_3d_info (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) NOT NULL, byte1 TINYINT UNSIGNED NOT NULL, path_loss TINYINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, byte1, path_loss)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
...
mysql -u user -pa --database='bttest' --execute="CREATE TABLE HCI_bdaddr_to_name (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) NOT NULL, status TINYINT NOT NULL, name_hex_str VARCHAR(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, status, name_hex_str)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
...
mysql -u user -pa --database='bttest' --execute="CREATE TABLE LE_bdaddr_to_3d_info (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) NOT NULL, bdaddr_random BOOLEAN NOT NULL, le_evt_type TINYINT UNSIGNED NOT NULL, byte1 TINYINT UNSIGNED NOT NULL, path_loss TINYINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, bdaddr_random, le_evt_type, byte1, path_loss)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
...
mysql -u user -pa --database='bttest' --execute="CREATE TABLE SDP_ERROR_RSP (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, direction TINYINT UNSIGNED NOT NULL, l2cap_len SMALLINT UNSIGNED NOT NULL, l2cap_cid SMALLINT UNSIGNED NOT NULL, transaction_id SMALLINT UNSIGNED NOT NULL, param_len SMALLINT UNSIGNED NOT NULL, error_code SMALLINT UNSIGNED NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, direction, l2cap_len, l2cap_cid, transaction_id, param_len, error_code)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

mysql -u user -pa --database='bttest' --execute="CREATE TABLE SDP_Common (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, direction TINYINT UNSIGNED NOT NULL, l2cap_len SMALLINT UNSIGNED NOT NULL, l2cap_cid SMALLINT UNSIGNED NOT NULL, pdu_id TINYINT UNSIGNED NOT NULL, transaction_id SMALLINT UNSIGNED NOT NULL, param_len SMALLINT UNSIGNED NOT NULL, byte_values VARBINARY(1024) NOT NULL, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, direction, l2cap_len, l2cap_cid, pdu_id, transaction_id, param_len, byte_values)) CHARACTER SET binary;"

# Tried using the hash construction to get around byte_values 1300 warning but it didn't work...
#mysql -u user -pa --database='bttest' --execute="CREATE TABLE SDP_Common (id INT NOT NULL AUTO_INCREMENT, bdaddr CHAR(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, direction TINYINT UNSIGNED NOT NULL, l2cap_len SMALLINT UNSIGNED NOT NULL, l2cap_cid SMALLINT UNSIGNED NOT NULL, pdu_id TINYINT UNSIGNED NOT NULL, transaction_id SMALLINT UNSIGNED NOT NULL, param_len SMALLINT UNSIGNED NOT NULL, byte_values VARBINARY(1024) NOT NULL, hash CHAR(40) GENERATED ALWAYS AS (SHA1(byte_values)) STORED, PRIMARY KEY (id), UNIQUE KEY uni_name (bdaddr, direction, l2cap_len, l2cap_cid, pdu_id, transaction_id, param_len, hash)) CHARACTER SET binary;"
