...
type_LMP_NAME_RES                        = 2
type_LMP_ACCEPTED                        = 3
type_LMP_NOT_ACCEPTED                    = 4
type_LMP_CLKOFFSET_REQ                   = 5
type_LMP_CLKOFFSET_RES                   = 6
type_LMP_DETACH                          = 7
type_LMP_IN_RAND                         = 8
type_LMP_COMB_KEY                        = 9
type_LMP_UNIT_KEY                        = 10
type_LMP_AU_RAND                         = 11
type_LMP_SRES                            = 12
type_LMP_TEMP_RAND                       = 13
type_LMP_TEMP_KEY                        = 14
type_LMP_ENCRYPTION_MODE_REQ             = 15
type_LMP_ENCRYPTION_KEY_SIZE_REQ         = 16
type_LMP_START_ENCRYPTION_REQ            = 17
type_LMP_STOP_ENCRYPTION_REQ             = 18
type_LMP_SWITCH_REQ                      = 19
type_LMP_HOLD                            = 20
type_LMP_HOLD_REQ                        = 21
type_LMP_SNIFF_REQ                       = 23
type_LMP_UNSNIFF_REQ                     = 24
type_LMP_PARK_REQ                        = 25
type_LMP_SET_BROADCAST_SCAN_WINDOW       = 27
type_LMP_MODIFY_BEACON                   = 28
type_LMP_UNPARK_BD_ADDR_REQ              = 29
type_LMP_UNPARK_PM_ADDR_REQ              = 30
type_LMP_INCR_POWER_REQ                  = 31
type_LMP_DECR_POWER_REQ                  = 32
type_LMP_MAX_POWER                       = 33
type_LMP_MIN_POWER                       = 34
type_LMP_AUTO_RATE                       = 35
type_LMP_PREFERRED_RATE                  = 36
type_LMP_VERSION_REQ                     = 37
type_LMP_VERSION_RES                     = 38
type_LMP_FEATURES_REQ                    = 39
type_LMP_FEATURES_RES                    = 40
type_LMP_QUALITY_OF_SERVICE              = 41
type_LMP_QUALITY_OF_SERVICE_REQ          = 42
type_LMP_SCO_LINK_REQ                    = 43
type_LMP_REMOVE_SCO_LINK_REQ             = 44
type_LMP_MAX_SLOT                        = 45
type_LMP_MAX_SLOT_REQ                    = 46
type_LMP_TIMING_ACCURACY_REQ             = 47
type_LMP_TIMING_ACCURACY_RES             = 48
type_LMP_SETUP_COMPLETE                  = 49
type_LMP_USE_SEMI_PERMANENT_KEY          = 50
type_LMP_HOST_CONNECTION_REQ             = 51
type_LMP_SLOT_OFFSET                     = 52
type_LMP_PAGE_MODE_REQ                   = 53
type_LMP_PAGE_SCAN_MODE_REQ              = 54
type_LMP_SUPERVISION_TIMEOUT             = 55
type_LMP_TEST_ACTIVATE                   = 56
type_LMP_TEST_CONTROL                    = 57
type_LMP_ENCRYPTION_KEY_SIZE_MASK_REQ    = 58
type_LMP_ENCRYPTION_KEY_SIZE_MASK_RES    = 59
type_LMP_SET_AFH                         = 60
type_LMP_ENCAPSULATED_HEADER             = 61
type_LMP_ENCAPSULATED_PAYLOAD            = 62
type_LMP_SIMPLE_PAIRING_CONFIRM          = 63
type_LMP_SIMPLE_PAIRING_NUMBER           = 64
type_LMP_DHKEY_CHECK                     = 65
...
type_ext_opcode_LMP_PACKET_TYPE_TABLE_REQ       = 11
...
lmp_pdu_opcodes_to_strings = {
    ...
    type_LMP_ACCEPTED:                        "LMP_ACCEPTED",
    type_LMP_NOT_ACCEPTED:                    "LMP_NOT_ACCEPTED",
    type_LMP_CLKOFFSET_REQ:                   "LMP_CLKOFFSET_REQ",
    type_LMP_CLKOFFSET_RES:                   "LMP_CLKOFFSET_RES",
    type_LMP_DETACH:                          "LMP_DETACH",
    type_LMP_IN_RAND:                         "LMP_IN_RAND",
    type_LMP_COMB_KEY:                        "LMP_COMB_KEY",
    type_LMP_UNIT_KEY:                        "LMP_UNIT_KEY",
    type_LMP_AU_RAND:                         "LMP_AU_RAND",
    type_LMP_SRES:                            "LMP_SRES",
    type_LMP_TEMP_RAND:                       "LMP_TEMP_RAND",
    type_LMP_TEMP_KEY:                        "LMP_TEMP_KEY",
    type_LMP_ENCRYPTION_MODE_REQ:             "LMP_ENCRYPTION_MODE_REQ",
    type_LMP_ENCRYPTION_KEY_SIZE_REQ:         "LMP_ENCRYPTION_KEY_SIZE_REQ",
    type_LMP_START_ENCRYPTION_REQ:            "LMP_START_ENCRYPTION_REQ",
    type_LMP_STOP_ENCRYPTION_REQ:             "LMP_STOP_ENCRYPTION_REQ",
    type_LMP_SWITCH_REQ:                      "LMP_SWITCH_REQ",
    type_LMP_HOLD:                            "LMP_HOLD",
    type_LMP_HOLD_REQ:                        "LMP_HOLD_REQ",
    type_LMP_SNIFF_REQ:                       "LMP_SNIFF_REQ",
    type_LMP_UNSNIFF_REQ:                     "LMP_UNSNIFF_REQ",
    type_LMP_PARK_REQ:                        "LMP_PARK_REQ",
    type_LMP_SET_BROADCAST_SCAN_WINDOW:       "LMP_SET_BROADCAST_SCAN_WINDOW",
    type_LMP_MODIFY_BEACON:                   "LMP_MODIFY_BEACON",
    type_LMP_UNPARK_BD_ADDR_REQ:              "LMP_UNPARK_BD_ADDR_REQ",
    type_LMP_UNPARK_PM_ADDR_REQ:              "LMP_UNPARK_PM_ADDR_REQ",
    type_LMP_INCR_POWER_REQ:                  "LMP_INCR_POWER_REQ",
    type_LMP_DECR_POWER_REQ:                  "LMP_DECR_POWER_REQ",
    type_LMP_MAX_POWER:                       "LMP_MAX_POWER",
    type_LMP_MIN_POWER:                       "LMP_MIN_POWER",
    type_LMP_AUTO_RATE:                       "LMP_AUTO_RATE",
    type_LMP_PREFERRED_RATE:                  "LMP_PREFERRED_RATE",
    ...
    type_LMP_QUALITY_OF_SERVICE:              "LMP_QUALITY_OF_SERVICE",
    type_LMP_QUALITY_OF_SERVICE_REQ:          "LMP_QUALITY_OF_SERVICE_REQ",
    type_LMP_SCO_LINK_REQ:                    "LMP_SCO_LINK_REQ",
    type_LMP_REMOVE_SCO_LINK_REQ:             "LMP_REMOVE_SCO_LINK_REQ",
    type_LMP_MAX_SLOT:                        "LMP_MAX_SLOT",
    type_LMP_MAX_SLOT_REQ:                    "LMP_MAX_SLOT_REQ",
    type_LMP_TIMING_ACCURACY_REQ:             "LMP_TIMING_ACCURACY_REQ",
    type_LMP_TIMING_ACCURACY_RES:             "LMP_TIMING_ACCURACY_RES",
    type_LMP_SETUP_COMPLETE:                  "LMP_SETUP_COMPLETE",
    type_LMP_USE_SEMI_PERMANENT_KEY:          "LMP_USE_SEMI_PERMANENT_KEY",
    type_LMP_HOST_CONNECTION_REQ:             "LMP_HOST_CONNECTION_REQ",
    type_LMP_SLOT_OFFSET:                     "LMP_SLOT_OFFSET",
    type_LMP_PAGE_MODE_REQ:                   "LMP_PAGE_MODE_REQ",
    type_LMP_PAGE_SCAN_MODE_REQ:              "LMP_PAGE_SCAN_MODE_REQ",
    type_LMP_SUPERVISION_TIMEOUT:             "LMP_SUPERVISION_TIMEOUT",
    type_LMP_TEST_ACTIVATE:                   "LMP_TEST_ACTIVATE",
    type_LMP_TEST_CONTROL:                    "LMP_TEST_CONTROL",
    type_LMP_ENCRYPTION_KEY_SIZE_MASK_REQ:    "LMP_ENCRYPTION_KEY_SIZE_MASK_REQ",
    type_LMP_ENCRYPTION_KEY_SIZE_MASK_RES:    "LMP_ENCRYPTION_KEY_SIZE_MASK_RES",
    type_LMP_SET_AFH:                         "LMP_SET_AFH",
    type_LMP_ENCAPSULATED_HEADER:             "LMP_ENCAPSULATED_HEADER",
    type_LMP_ENCAPSULATED_PAYLOAD:            "LMP_ENCAPSULATED_PAYLOAD",
    type_LMP_SIMPLE_PAIRING_CONFIRM:          "LMP_SIMPLE_PAIRING_CONFIRM",
    type_LMP_SIMPLE_PAIRING_NUMBER:           "LMP_SIMPLE_PAIRING_NUMBER",
    type_LMP_DHKEY_CHECK:                     "LMP_DHKEY_CHECK",
    type_LMP_PAUSE_ENCRYPTION_AES_REQ:        "LMP_PAUSE_ENCRYPTION_AES_REQ",
...
lmp_pdu_ext_opcodes_to_strings = {
    ...
    type_ext_opcode_LMP_PACKET_TYPE_TABLE_REQ:      "LMP_PACKET_TYPE_TABLE_REQ",
