...
rm /tmp/specific.csv
mysql --database='bt2' --execute='ALTER DATABASE bt CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci'
mysql --database='bt2' --execute='DROP TABLE adv_specific'
mysql --database='bt2' --execute='DROP TABLE gps_specific'
mysql --database='bt2' --execute="CREATE TABLE adv_specific (id INT NOT NULL AUTO_INCREMENT, capture_date_unix INT(11) NOT NULL, rssi TINYINT NOT NULL, bdaddr_random VARCHAR(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL, bdaddr VARCHAR(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL, device_name VARCHAR(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL, PRIMARY KEY (id)) CHARACTER SET utf8mb3;"
#mysql --database='bt2' --execute='ALTER TABLE adv_specific CONVERT TO CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci'
mysql --database='bt2' --execute='CREATE TABLE gps_specific (unix_host_time INT(11) NOT NULL, unix_gps_time INT(11) NOT NULL, lat DECIMAL(10, 8) NOT NULL, lon DECIMAL(11, 8) NOT NULL, PRIMARY KEY (unix_host_time));'
...
mysql --database='bt2' --execute="SELECT device_name, bdaddr, rssi, lat, lon FROM adv_specific INNER JOIN gps_specific ON adv_specific.capture_date_unix = gps_specific.unix_host_time INTO OUTFILE '/tmp/specific.csv' FIELDS TERMINATED BY ',' ENCLOSED BY '\"' LINES TERMINATED BY '\n';"
