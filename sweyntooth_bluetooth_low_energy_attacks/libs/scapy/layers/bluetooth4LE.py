...
BTLE_CtrlPDU_optcode = {
    ...
    0x14: 'LL_LENGTH_REQ',
    0x15: 'LL_LENGTH_RSP',
    0x16: 'LL_PHY_REQ', # from BT 5.0
    0x17: 'LL_PHY_RSP', # from BT 5.0
}
...
class LL_PHY_REQ(Packet):
    name = ' LL_PHY_REQ'
    fields_desc = [
        XByteField("tx_phys", 1),
        XByteField("rx_phys", 1),
    ]
...
bind_layers(CtrlPDU, LL_PING_REQ, optcode=0x12)  # BTLE_DATA / CtrlPDU / LL_PING_REQ
bind_layers(CtrlPDU, LL_PING_RSP, optcode=0x13)  # BTLE_DATA / CtrlPDU / LL_PING_RSP
...
bind_layers(CtrlPDU, LL_PHY_REQ, optcode=0x16)  # BTLE_DATA / CtrlPDU / LL_PHY_REQ
bind_layers(CtrlPDU, LL_PHY_RSP, optcode=0x17)  # BTLE_DATA / CtrlPDU / LL_PHY_RSP
# TODO: more optcodes
